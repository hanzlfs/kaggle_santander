	...
	if tr_out_file:
		...
		with open(tr_out_file, 'w') as fp:
			...
			for i in range(len(y_vars_list_tr)):
				wr.writerow(y_vars_list_tr[i] + [0] + x_vars_list_tr[i])
...
if __name__ == "__main__":
	...
	tr_out_file = "../input/tr_sample_feature_v3.csv" # in v3 we keep original structure of train for binary classification
	val_out_file = "../input/val_sample_feature_v3.csv"
	data_path = "../input/"
