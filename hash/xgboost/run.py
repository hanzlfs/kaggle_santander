...
"""
cmd = 'python count_target.py ../input/tr_sample_feature_v2.csv > ../input/fc.trva.t10.target.txt'
subprocess.call(cmd, shell=True) 
"""

cmd = 'python preB.py -f train ../input/tr_sample_feature_v2.csv ../input/tr.gbdt.out ../input/tr.hashtk'
subprocess.call(cmd, shell=True)

cmd = 'python preB.py -f val ../input/val_sample_feature_v2.csv ../input/val.gbdt.out ../input/val.hashtk'
subprocess.call(cmd, shell=True)
